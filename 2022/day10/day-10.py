...
for i in range(1, len(cycles)):
    crt += '#' if cycles[i] <= (i % 40) <= cycles[i] + 2 else '.'
    crt += '\n' if i in [40, 80, 120, 160, 200, 240] else ''
...
print(f'Part 1: %d' % sum(cycles[p - 1] * p for p in [20, 60, 100, 140, 180, 220]))

crt = ''
for i in range(len(cycles)):
    crt += '#' if cycles[i] <= (i % 40) + 1 <= cycles[i] + 2 else '.'
    crt += '\n' if i + 1 in [40, 80, 120, 160, 200, 240] else ''
